...
{
    public class SlugGeneratorOneSheet<T> : ExcelGenerator<T>
    {
        private dynamic _model;
        
        public SlugGeneratorOneSheet(string filePath, dynamic model) : base(filePath)
        {
            _model = model;
        ...
        public override string CreateExcelFile(List<T> data, string selectedPrefabJob)
        {
            ...
            try
            {
                ...
                using (document)
                {
                    ...
                    {
                        CreatePartsForExcel(document, groupedSlugs.ToList(), $"PrefabJob - {groupedSlugs.Key}");
                    }
        ...
        protected override void CreatePartsForExcel(SpreadsheetDocument document, List<T> data, string sheetName)
        {
