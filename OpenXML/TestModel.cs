...
namespace CadDev.Excel.OpenXML
{
    ...
    public class TestModel
    {
        ...
        public void CreateExcelFile(List<List<Slug>> data, string OutPutFileDirectory)
        {
        ...
        private void CreatePartsForExcel(SpreadsheetDocument document, List<List<Slug>> GroupedList)
        {
            ...
            {
                var sheetName = testModels.First().NominalDiameter.ToString();
        ...
        private SheetData GenerateSheetdataForDetails(List<Slug> data)
        {
            SheetData sheetData1 = new SheetData();

            foreach (Slug testmodel in data)
            {
        ...
        private Row CreateHeaderRowForExcel(Slug testmodel)
        {
            Row workRow = new Row();

            foreach (PropertyInfo propertyInfo in testmodel.GetType().GetProperties())
            {
        ...
        private Row GenerateRowForChildPartDetail(Slug testmodel)
        {

            Row tRow = new Row();
            foreach (PropertyInfo propertyInfo in testmodel.GetType().GetProperties())
            {
                var value = propertyInfo.GetValue(testmodel);
